...
- **Clean Typography**: Modern and readable font styling
- **Smooth Animations**: Hover effects and transitions throughout
- **Accessibility**: ARIA labels, alt text, and semantic landmarks
- **Interactive Elements**: 
  - Hamburger menu for mobile devices
  - Project cards with hover descriptions
...
3. **Projects**: Showcase of projects with hover descriptions
...
- Email: abhisekhj0@gmail.com
- GitHub: [@AbhisekhJha](https://github.com/AbhisekhJha)
- LinkedIn: [Abhisekh Kumar Jha](https://www.linkedin.com/in/abhisekh-kumar-jha-491185212/)
